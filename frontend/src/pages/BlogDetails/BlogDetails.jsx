...
function BlogDetails() {
  ...
  useEffect(() => 
  {
    async function getBlogDetails() 
    {
      ...
      {
        setComments(commentResponse.data); // Use commentResponse.data directly
      } 
      else 
      {
        // Handle other status codes as needed
        console.error("Error fetching comments. Status:", commentResponse.status);
      }
      ...
      {
        // Handle other status codes as needed
        console.error("Error fetching blog details. Status:", blogResponse.status);
      }
    }
    getBlogDetails();
  }, [reload]);
  ...
  return (
    <h1 className={styles.detailsWrapper}>
